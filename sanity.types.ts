...
export type LoungeReference = {
  _ref: string;
  _type: "reference";
  _weak?: boolean;
  [internalGroqTypeReferenceTo]?: "lounge";
};
...
export type FetchProductResult = {
  ...
  variants: Array<{
    _key: string;
    size: "L" | "M" | "One size" | "S" | "XL" | "XS" | "XXL" | null;
    stock: number | null;
    sold: number | null;
  }> | null;
} | null;
